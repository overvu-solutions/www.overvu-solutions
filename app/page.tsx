        ...
        <div className="w-full justify-center pt-20">
          ...
          <div className="justify-center">
            <div className="text-justify text-xl max-w-screen-md mb-4">
              Our team consists of both academics and industry professionals. On
              the scientific side, we focus on network algorithms, with
              specialists in the areas of supply chains. Fine tuning LLMs and
              runing benchmarks on them. 
            </div>
            <div className="text-justify text-xl max-w-screen-md">
            On the engineering side, building
              workflows and solutions based on LLMs for different use cases with
              understanding of proc and cons of LLMs. Moreover, creating
