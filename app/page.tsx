  ...
  return (
    <div className=" w-full md:w-36 flex flex-col">
      <div className="p-0 flex justify-center">
        <img src={pic} className={`grayscale hover:grayscale-0 duration-500 rounded-full avatar`} alt="" />
      </div>
...
export default function Home() {
  return (
    <div className="grid  items-center justify-items-center min-h-screen  pb-20 gap-16 sm:p-1 ">
